...
CAPABILITY_SMOKE_ROOT = Path(__file__).resolve().parent.parent / "fixtures" / "capability_smoke"
IGNORE_SMOKE_ROOT = Path(__file__).resolve().parent.parent / "fixtures" / "lancedb_ignore_smoke"
